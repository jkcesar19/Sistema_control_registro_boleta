...
public class VistaMaqui extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PanelVistaMaquina = new javax.swing.JPanel();
        ...
        PanelVistaMaquina.setBackground(new java.awt.Color(0, 153, 0));

        javax.swing.GroupLayout PanelVistaMaquinaLayout = new javax.swing.GroupLayout(PanelVistaMaquina);
        PanelVistaMaquina.setLayout(PanelVistaMaquinaLayout);
        PanelVistaMaquinaLayout.setHorizontalGroup(
            PanelVistaMaquinaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        PanelVistaMaquinaLayout.setVerticalGroup(
            PanelVistaMaquinaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 340, Short.MAX_VALUE)
        );

        jPanel2.add(PanelVistaMaquina, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 750, 340));
    ...
    private void btnAddMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMousePressed
        ...
        try {
            ...
            Logger.getLogger(VistaMaqui.class.getName()).log(Level.SEVERE, null, ex);
        }
                ...
                if (opt == 'E') {
                    ...
                    if (rpta == 0) {
                        if (MaquinariaBo.eliminarMaquina(objMaquina)) {
                            ...
                            JOptionPane.showMessageDialog(this, "No se pudo Eliminar", "Material",
                                    JOptionPane.ERROR_MESSAGE);
                        }
                    }
                }
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this, e.getMessage(), "Material", JOptionPane.ERROR_MESSAGE);
            }
        } else {
    ...
    protected static javax.swing.JPanel PanelVistaMaquina;
