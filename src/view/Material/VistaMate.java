...
public class VistaMate extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        PanelVistaMat = new javax.swing.JPanel();
        ...
        PanelVistaMat.setBackground(new java.awt.Color(0, 153, 0));

        javax.swing.GroupLayout PanelVistaMatLayout = new javax.swing.GroupLayout(PanelVistaMat);
        PanelVistaMat.setLayout(PanelVistaMatLayout);
        PanelVistaMatLayout.setHorizontalGroup(
            PanelVistaMatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 0, Short.MAX_VALUE)
        );
        PanelVistaMatLayout.setVerticalGroup(
            PanelVistaMatLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 340, Short.MAX_VALUE)
        );

        jPanel2.add(PanelVistaMat, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 6, 750, 340));
    ...
    private void btnAddMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMousePressed
        ...
        try {
            ...
            Logger.getLogger(VistaMate.class.getName()).log(Level.SEVERE, null, ex);
        }
        ...
        if (lista_eliminar.id != 0) {
            ...
            try {
                ...
                if (opt == 'E') {
                    ...
                    if (rpta == 0) {
                        if (MaterialBo.elimanarMaterial(objMaterial)) {
    ...
    protected static javax.swing.JPanel PanelVistaMat;
