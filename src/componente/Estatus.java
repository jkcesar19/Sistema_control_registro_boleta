...
public class Estatus extends javax.swing.JPanel {

    public Estatus(ModelEstatus status) {
        initComponents();
        setOpaque(false);
        labelStatus1.setText(status.getEstatus());
    }
    ...
    private void initComponents() {
        ...
        labelStatus1 = new component.LabelStatus();
    ...
    private component.LabelStatus labelStatus1;
